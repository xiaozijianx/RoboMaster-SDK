...
def group_up(multi_drone,tello_group,dis):
    multi_drone.run([tello_group, up, [20]])
...
if __name__ == '__main__':
    ...
    keyboard.add_hotkey('left', rc_left,  args=(tl_flight,20,))
    keyboard.add_hotkey('right', rc_left,  args=(tl_flight,-20,))

    keyboard.add_hotkey('e', take_off,  args=(tl_flight,))
    keyboard.add_hotkey('q', land,  args=(tl_flight,))

    keyboard.add_hotkey('w', rc_forward,  args=(tl_flight,20,))
    keyboard.add_hotkey('s', rc_forward,  args=(tl_flight,-20,))
